basic_ambient is a trialsofretribution starting point for effects that emit continuously over time and never stop playing on their own.  The example featured here is a small column of ambient environmental smoke or steam.
